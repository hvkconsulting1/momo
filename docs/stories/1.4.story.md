...
- src/momo/data/validation.py - ValidationReport dataclass and validate_prices() skeleton implementation
- tests/stories/1.4/conftest.py - Story-level fixtures including sample_price_df_clean
